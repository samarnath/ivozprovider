...
class QueueDTO implements DataTransferObjectInterface
{
    ...
    public function transformForeignKeys(ForeignKeyTransformerInterface $transformer)
    {
        ...
        $this->periodicAnnounceLocution = $transformer->transform('Ivoz\\Domain\\Model\\Locution\\Locution', $this->getPeriodicAnnounceLocutionId());
        $this->timeoutLocution = $transformer->transform('Ivoz\\Domain\\Model\\Locution\\Locution', $this->getTimeoutLocutionId());
        ...
        $this->fullLocution = $transformer->transform('Ivoz\\Domain\\Model\\Locution\\Locution', $this->getFullLocutionId());
        $this->fullExtension = $transformer->transform('Ivoz\\Domain\\Model\\Extension\\Extension', $this->getFullExtensionId());
        $this->fullVoiceMailUser = $transformer->transform('Ivoz\\Domain\\Model\\User\\User', $this->getFullVoiceMailUserId());
    }
