...
class PickUpRelUserDTO implements DataTransferObjectInterface
{
    ...
    {
        $this->pickUpGroup = $transformer->transform('Ivoz\\Domain\\Model\\PickUpGroup\\PickUpGroup', $this->getPickUpGroupId());
    ...
    /**
     * @return \Ivoz\Domain\Model\PickUpGroup\PickUpGroup
     */
