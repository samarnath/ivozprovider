...
class InvoiceDTO implements DataTransferObjectInterface
{
    ...
    {
        $this->invoiceTemplate = $transformer->transform('Ivoz\\Domain\\Model\\InvoiceTemplate\\InvoiceTemplate', $this->getInvoiceTemplateId());
    ...
    /**
     * @return \Ivoz\Domain\Model\InvoiceTemplate\InvoiceTemplate
     */
