...
class LcrRuleTargetDTO implements DataTransferObjectInterface
{
    ...
    {
        $this->rule = $transformer->transform('Ivoz\\Domain\\Model\\LcrRule\\LcrRule', $this->getRuleId());
        $this->gw = $transformer->transform('Ivoz\\Domain\\Model\\LcrGateway\\LcrGateway', $this->getGwId());
        $this->outgoingRouting = $transformer->transform('Ivoz\\Domain\\Model\\OutgoingRouting\\OutgoingRouting', $this->getOutgoingRoutingId());
    }
    ...
    /**
     * @return \Ivoz\Domain\Model\LcrRule\LcrRule
     */
    ...
    /**
     * @return \Ivoz\Domain\Model\LcrGateway\LcrGateway
     */
    ...
    /**
     * @return \Ivoz\Domain\Model\OutgoingRouting\OutgoingRouting
     */
