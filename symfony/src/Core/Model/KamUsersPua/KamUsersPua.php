...
namespace Core\Model\KamUsersPua;

use Assert\Assertion;
use Core\Application\DTO\KamUsersPuaDTO;
 ...
 * KamUsersPua
 */
class KamUsersPua implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new KamUsersPuaDTO();
    }

    /**
     * Factory method
     * @param KamUsersPuaDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamUsersPuaDTO::class);
