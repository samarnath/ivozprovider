...
namespace Core\Model\AstVoicemail;

use Assert\Assertion;
use Core\Application\DTO\AstVoicemailDTO;
 ...
 * AstVoicemail
 */
class AstVoicemail implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new AstVoicemailDTO();
    }

    /**
     * Factory method
     * @param AstVoicemailDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, AstVoicemailDTO::class);
        ...
        return $self
            ...
            ->setTz($dto->getTz())
            ->setDeleteastVoicemail($dto->getDeleteastVoicemail())
            ->setSaycid($dto->getSaycid())
            ->setSendastVoicemail($dto->getSendastVoicemail())
    ...
    public function toDTO()
    {
        return self::createDTO()
            ...
            ->setTz($this->getTz())
            ->setDeleteastVoicemail($this->getDeleteastVoicemail())
            ->setSaycid($this->getSaycid())
            ->setSendastVoicemail($this->getSendastVoicemail())
    ...
    /**
     * Set deleteastVoicemail
     *
     * @param string $deleteastVoicemail
     *
     * @return AstVoicemail
     */
    protected function setDeleteastVoicemail($deleteastVoicemail = null)
    {
        if (!is_null($deleteastVoicemail)) {
        }
    ...
    /**
     * Set sendastVoicemail
     *
     * @param string $sendastVoicemail
     *
     * @return AstVoicemail
     */
    protected function setSendastVoicemail($sendastVoicemail = null)
    {
        if (!is_null($sendastVoicemail)) {
        }
