...
namespace Core\Model\KamUsersWatcher;

use Assert\Assertion;
use Core\Application\DTO\KamUsersWatcherDTO;
 ...
 * KamUsersWatcher
 */
class KamUsersWatcher implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new KamUsersWatcherDTO();
    }

    /**
     * Factory method
     * @param KamUsersWatcherDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamUsersWatcherDTO::class);
