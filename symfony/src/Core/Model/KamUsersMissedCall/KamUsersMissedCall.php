...
namespace Core\Model\KamUsersMissedCall;

use Assert\Assertion;
use Core\Application\DTO\KamUsersMissedCallDTO;
 ...
 * KamUsersMissedCall
 */
class KamUsersMissedCall implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    /**
     * @return KamUsersMissedCallDTO
     */
    public static function createDTO()
    {
        return new KamUsersMissedCallDTO();
    }

    /**
     * Factory method
     * @param KamUsersMissedCallDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamUsersMissedCallDTO::class);
