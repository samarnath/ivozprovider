...
namespace Core\Model\KamUsersAcc;

use Assert\Assertion;
use Core\Application\DTO\KamUsersAccDTO;
 ...
 * KamUsersAcc
 */
class KamUsersAcc implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    /**
     * @return KamUsersAccDTO
     */
    public static function createDTO()
    {
        return new KamUsersAccDTO();
    }

    /**
     * Factory method
     * @param KamUsersAccDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamUsersAccDTO::class);
