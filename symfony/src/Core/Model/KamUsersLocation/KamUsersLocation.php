...
namespace Core\Model\KamUsersLocation;

use Assert\Assertion;
use Core\Application\DTO\KamUsersLocationDTO;
 ...
 * KamUsersLocation
 */
class KamUsersLocation implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new KamUsersLocationDTO();
    }

    /**
     * Factory method
     * @param KamUsersLocationDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamUsersLocationDTO::class);
