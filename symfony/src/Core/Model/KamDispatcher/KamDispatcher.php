...
namespace Core\Model\KamDispatcher;

use Assert\Assertion;
use Core\Application\DTO\KamDispatcherDTO;
 ...
 * KamDispatcher
 */
class KamDispatcher implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new KamDispatcherDTO();
    }

    /**
     * Factory method
     * @param KamDispatcherDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamDispatcherDTO::class);
