...
namespace Core\Model\KamUsersXcap;

use Assert\Assertion;
use Core\Application\DTO\KamUsersXcapDTO;
 ...
 * KamUsersXcap
 */
class KamUsersXcap implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new KamUsersXcapDTO();
    }

    /**
     * Factory method
     * @param KamUsersXcapDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamUsersXcapDTO::class);
