...
namespace Kam\Model\KamTrunksHtable;

use Assert\Assertion;
use Kam\Application\DTO\KamTrunksHtableDTO;
 ...
 * KamTrunksHtable
 */
class KamTrunksHtable implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    /**
     * @return KamTrunksHtableDTO
     */
    public static function createDTO()
    {
        return new KamTrunksHtableDTO();
    }

    /**
     * Factory method
     * @param KamTrunksHtableDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamTrunksHtableDTO::class);
