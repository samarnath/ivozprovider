...
namespace Kam\Model\KamTrunksDialplan;

use Assert\Assertion;
use Kam\Application\DTO\KamTrunksDialplanDTO;
 ...
 * KamTrunksDialplan
 */
class KamTrunksDialplan implements EntityInterface
{
    /**
     * @var integer
     */
    ...
    {
        return new KamTrunksDialplanDTO();
    }

    /**
     * Factory method
     * @param KamTrunksDialplanDTO $dto
     * @return self
     */
    public static function fromDTO(DataTransferObjectInterface $dto)
    {
        Assertion::isInstanceOf($dto, KamTrunksDialplanDTO::class);
